...
/***********************************************
 * <P> desc: 给 GridLayoutManager or StaggeredGridLayoutManager 设置间距，可设置去除首尾间距个数
 * <P> Author: Hhq
 * <P> Copyright 2019 Guang-inc
 ***********************************************/
...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridItemDecoration(int spacing, boolean includeEdge) {
     ...
     */
    public GridItemDecoration setStartFrom(int startFromSize) {
     ...
     */
    public GridItemDecoration setEndFromSize(int endFromSize) {
     ...
     */
    public GridItemDecoration setNoShowSpace(int startFromSize, int endFromSize) {
        this.mStartFromSize = startFromSize;
        this.mEndFromSize = endFromSize;
        return this;
    }
